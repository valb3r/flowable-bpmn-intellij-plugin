...
enum class FlowablePropertyTypeDetails(val details: PropertyTypeDetails) {
    ...
    ASYNC_LEAVE(PropertyTypeDetails(PropertyType.ASYNC_LEAVE, "flowable:asyncLeave", XmlType.ATTRIBUTE)),
    ...
    STORE_RESULT_VARIABLE_AS_TRANSIENT(PropertyTypeDetails(PropertyType.STORE_RESULT_VARIABLE_AS_TRANSIENT, "flowable:storeResultVariableAsTransient", XmlType.ATTRIBUTE)),
