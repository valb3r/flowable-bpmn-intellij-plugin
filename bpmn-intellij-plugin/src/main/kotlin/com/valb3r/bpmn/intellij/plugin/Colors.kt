...
enum class Colors(val color: JBColor) {
    ...
    TRANSACTION_COLOR(JBColor(Color(0xF9F9F9), Color(0x292B2D))),
    TRANSACTION_ELEMENT_BORDER_COLOR(JBColor(Color(0x292B2D), Color(0xF9F9F9))),
    PROCESS_COLOR(JBColor(Color(0xC9C9C9), Color(0x292B2D))),
    CALL_ACTIVITY_COLOR(JBColor(Color(0xC9C9C9), Color(0x535353))),
    ...
    START_EVENT(JBColor(Color(0x00EE00), Color(0x009900))),
