...
enum class PropertyTypeDetails(
    ...
    SKIP_EXPRESSION(PropertyType.SKIP_EXPRESSION, "activiti:skipExpression", XmlType.ATTRIBUTE),
    IS_TRIGGERABLE(PropertyType.IS_TRIGGERABLE, "activiti:triggerable", XmlType.ATTRIBUTE),
    DUE_DATE(PropertyType.DUE_DATE, "activiti:dueDate", XmlType.ATTRIBUTE),
    CATEGORY(PropertyType.CATEGORY, "activiti:category", XmlType.ATTRIBUTE),
    FORM_KEY(PropertyType.FORM_KEY, "activiti:formKey", XmlType.ATTRIBUTE),
    FORM_FIELD_VALIDATION(PropertyType.FORM_FIELD_VALIDATION, "activiti:formFieldValidation", XmlType.ATTRIBUTE),
    ...
    AUTO_STORE_VARIABLES(PropertyType.AUTO_STORE_VARIABLES, "activiti:autoStoreVariables", XmlType.ATTRIBUTE),
