package com.valb3r.bpmn.intellij.plugin.activiti.parser.custom
...
internal class ActivitiUsereventWithNestedExtensionTest {
    ...
    fun `Start event with nested extensions is parseable`() {
        ...
        val props = BpmnFileObject(processObject.processes, processObject.diagram).toView(ActivitiObjectFactory()).processes[0].processElemPropertiesByElementId[event.id]!!
