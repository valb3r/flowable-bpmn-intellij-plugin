...
internal class CollapsedSubprocessTest {
    ...
    fun `Collapsed subprocess is readable and mapped`() {
        ...
        processObject = ActivitiParser().parse("simple-collapsed-subprocess.bpmn20.xml".asResource()!!)
    ...
    fun `Collapsed transactional subprocess is readable and mapped`() {
        ...
        processObject = ActivitiParser().parse("transactional-collapsed-subprocess.bpmn20.xml".asResource()!!)
