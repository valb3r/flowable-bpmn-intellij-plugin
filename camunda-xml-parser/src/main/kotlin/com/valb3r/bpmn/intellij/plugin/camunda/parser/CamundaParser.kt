...
enum class CamundaPropertyTypeDetails(val details: PropertyTypeDetails) {
    ...
    BPMN_INCOMING(PropertyTypeDetails(PropertyType.BPMN_INCOMING, "incoming?text=@.text", XmlType.CDATA)),
    BPMN_OUTGOING(PropertyTypeDetails(PropertyType.BPMN_OUTGOING, "outgoing?text=@.text", XmlType.CDATA)),
