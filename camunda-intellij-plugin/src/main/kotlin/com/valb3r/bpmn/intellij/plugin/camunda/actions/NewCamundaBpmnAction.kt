...
private const val NEW_FILE = "New Camunda BPMN 2.0 file"

class NewCamundaBpmnAction:
        CreateFileFromTemplateAction(
            NEW_FILE,
            "Create new Camunda BPMN process",
    ...
    override fun buildDialog(project: Project, directory: PsiDirectory, builder: CreateFileFromTemplateDialog.Builder) {
        builder
                .setTitle(NEW_FILE)
                .addKind("File", currentIconProvider().script, "new-camunda-diagram.bpmn")
    }
    ...
    override fun createFileFromTemplate(name: String, template: FileTemplate, dir: PsiDirectory) = try {
        ...
        CreateFromTemplateDialog(project, dir, template, AttributesDefaults("$fileName.bpmn").withFixedName(true), properties)
                .create()
                .containingFile
    } catch (e: Exception) {
