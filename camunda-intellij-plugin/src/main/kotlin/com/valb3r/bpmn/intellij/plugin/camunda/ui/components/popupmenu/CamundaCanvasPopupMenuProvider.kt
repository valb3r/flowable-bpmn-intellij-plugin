...
class CamundaCanvasPopupMenuProvider(private val project: Project) : BaseCanvasPopupMenuProvider(project) {
    ...
    override fun mutateIntermediateCatchingEvent(popup: JBPopupMenu, focus: BpmnElementId) {
        ...
        addItem(popup, "Intermediate link catching event", INTERMEDIATE_LINK_CATCHING, ShapeTypeChange(project, BpmnIntermediateConditionalCatchingEvent::class, focus))
    }
    ...
    override fun mutateGateway(popup: JBPopupMenu, focus: BpmnElementId) {
        ...
        addItem(popup, "Complex gateway", COMPLEX_GATEWAY, ShapeTypeChange(project, BpmnComplexGateway::class, focus))
    }

    override fun mutateTask(popup: JBPopupMenu, focus: BpmnElementId) {
        addItem(popup, "Task", TASK, ShapeTypeChange(project, BpmnTask::class, focus))
        ...
        addItem(popup, "Send task", SEND_TASK, ShapeTypeChange(project, BpmnSendTask::class, focus))
        ...
        addItem(popup, "External task", MANUAL_TASK, ShapeTypeChange(project, BpmnExternalTask::class, focus))
    }
