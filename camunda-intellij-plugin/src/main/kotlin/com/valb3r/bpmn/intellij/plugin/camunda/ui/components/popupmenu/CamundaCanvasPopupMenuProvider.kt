...
class CamundaCanvasPopupMenuProvider(private val project: Project) : CanvasPopupMenuProvider {
    ...
    // Functional
    private val COPY = IconLoader.getIcon("/icons/actions/copy.png", CamundaCanvasPopupMenuProvider::class.java)
    private val CUT = IconLoader.getIcon("/icons/actions/cut.png", CamundaCanvasPopupMenuProvider::class.java)
    private val PASTE = IconLoader.getIcon("/icons/actions/paste.png", CamundaCanvasPopupMenuProvider::class.java)
    private val SAVE_TO_PNG = IconLoader.getIcon("/icons/actions/save-to-png.png", CamundaCanvasPopupMenuProvider::class.java)

    // Events
    // Start
    private val START_EVENT = IconLoader.getIcon("/icons/popupmenu/start-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val START_CONDITIONAL_EVENT = IconLoader.getIcon("/icons/popupmenu/conditional-start-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val START_MESSAGE_EVENT = IconLoader.getIcon("/icons/popupmenu/message-start-event.png", CamundaCanvasPopupMenuProvider::class.java)
    // private val START_ERROR_EVENT = IconLoader.getIcon("/icons/popupmenu/error-start-event.png", CamundaCanvasPopupMenuProvider::class.java)
    // private val START_ESCALATION_EVENT = IconLoader.getIcon("/icons/popupmenu/escalation-start-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val START_SIGNAL_EVENT = IconLoader.getIcon("/icons/popupmenu/signal-start-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val START_TIMER_EVENT = IconLoader.getIcon("/icons/popupmenu/timer-start-event.png", CamundaCanvasPopupMenuProvider::class.java)
    // End
    private val END_EVENT = IconLoader.getIcon("/icons/popupmenu/end-event.png", CamundaCanvasPopupMenuProvider::class.java)
    // private val CANCEL_END_EVENT = IconLoader.getIcon("/icons/popupmenu/cancel-end-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val ERROR_END_EVENT = IconLoader.getIcon("/icons/popupmenu/error-end-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val ESCALATION_END_EVENT = IconLoader.getIcon("/icons/popupmenu/escalation-end-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val TERMINATE_END_EVENT = IconLoader.getIcon("/icons/popupmenu/terminate-end-event.png", CamundaCanvasPopupMenuProvider::class.java)
    // Boundary
//    private val BOUNDARY_CANCEL_EVENT = IconLoader.getIcon("/icons/popupmenu/cancel-boundary-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_COMPENSATION_EVENT = IconLoader.getIcon("/icons/popupmenu/compensation-boundary-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_CONDITIONAL_EVENT = IconLoader.getIcon("/icons/popupmenu/conditional-boundary-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_ERROR_EVENT = IconLoader.getIcon("/icons/popupmenu/error-boundary-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_ESCALATION_EVENT = IconLoader.getIcon("/icons/popupmenu/escalation-boundary-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_MESSAGE_EVENT = IconLoader.getIcon("/icons/popupmenu/message-boundary-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_SIGNAL_EVENT = IconLoader.getIcon("/icons/popupmenu/signal-boundary-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_TIMER_EVENT = IconLoader.getIcon("/icons/popupmenu/timer-boundary-event.png", CamundaCanvasPopupMenuProvider::class.java)
    // Intermediate events
    // Catch
    private val INTERMEDIATE_TIMER_CATCHING = IconLoader.getIcon("/icons/popupmenu/timer-catch-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val INTERMEDIATE_MESSAGE_CATCHING = IconLoader.getIcon("/icons/popupmenu/message-catch-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val INTERMEDIATE_SIGNAL_CATCHING = IconLoader.getIcon("/icons/popupmenu/signal-catch-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val INTERMEDIATE_CONDITIONAL_CATCHING = IconLoader.getIcon("/icons/popupmenu/conditional-catch-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val INTERMEDIATE_LINK_CATCHING = IconLoader.getIcon("/icons/popupmenu/intermediate-link-catch-event.png", CamundaCanvasPopupMenuProvider::class.java)
    // Throw
    private val INTERMEDIATE_NONE_THROWING = IconLoader.getIcon("/icons/popupmenu/none-throw-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val INTERMEDIATE_SIGNAL_THROWING = IconLoader.getIcon("/icons/popupmenu/signal-throw-event.png", CamundaCanvasPopupMenuProvider::class.java)
    private val INTERMEDIATE_ESCALATION_THROWING = IconLoader.getIcon("/icons/popupmenu/escalation-throw-event.png", CamundaCanvasPopupMenuProvider::class.java)

    // Service-task alike
    private val TASK = IconLoader.getIcon("/icons/popupmenu/call-activity.png", CamundaCanvasPopupMenuProvider::class.java)
    private val SERVICE_TASK = IconLoader.getIcon("/icons/popupmenu/service-task.png", CamundaCanvasPopupMenuProvider::class.java)
    private val USER_TASK = IconLoader.getIcon("/icons/popupmenu/user-task.png", CamundaCanvasPopupMenuProvider::class.java)
    private val SCRIPT_TASK = IconLoader.getIcon("/icons/popupmenu/script-task.png", CamundaCanvasPopupMenuProvider::class.java)
    private val BUSINESS_RULE_TASK = IconLoader.getIcon("/icons/popupmenu/business-rule-task.png", CamundaCanvasPopupMenuProvider::class.java)
    private val SEND_TASK = IconLoader.getIcon("/icons/popupmenu/send-task.png", CamundaCanvasPopupMenuProvider::class.java)
    private val RECEIVE_TASK = IconLoader.getIcon("/icons/popupmenu/receive-task.png", CamundaCanvasPopupMenuProvider::class.java)
    private val MANUAL_TASK = IconLoader.getIcon("/icons/popupmenu/manual-task.png", CamundaCanvasPopupMenuProvider::class.java)
//    private val CAMEL_TASK = IconLoader.getIcon("/icons/popupmenu/camel-task.png", CamundaCanvasPopupMenuProvider::class.java)
//    private val HTTP_TASK = IconLoader.getIcon("/icons/popupmenu/http-task.png", CamundaCanvasPopupMenuProvider::class.java)
//    private val MAIL_TASK = IconLoader.getIcon("/icons/popupmenu/mail-task.png", CamundaCanvasPopupMenuProvider::class.java)
//    private val MULE_TASK = IconLoader.getIcon("/icons/popupmenu/mule-task.png", CamundaCanvasPopupMenuProvider::class.java)
//    private val DECISION_TASK = IconLoader.getIcon("/icons/popupmenu/decision-task.png", CamundaCanvasPopupMenuProvider::class.java)
//    private val SHELL_TASK = IconLoader.getIcon("/icons/popupmenu/shell-task.png", CamundaCanvasPopupMenuProvider::class.java)

    // Sub process alike
    private val CALL_ACTIVITY = IconLoader.getIcon("/icons/popupmenu/call-activity.png", CamundaCanvasPopupMenuProvider::class.java)
    private val SUB_PROCESS = IconLoader.getIcon("/icons/popupmenu/subprocess.png", CamundaCanvasPopupMenuProvider::class.java)
    private val EVENT_SUB_PROCESS = IconLoader.getIcon("/icons/popupmenu/event-subprocess.png", CamundaCanvasPopupMenuProvider::class.java)
    private val ADHOC_SUB_PROCESS = IconLoader.getIcon("/icons/popupmenu/adhoc-subprocess.png", CamundaCanvasPopupMenuProvider::class.java)

    // Gateway
    private val EXCLUSIVE_GATEWAY = IconLoader.getIcon("/icons/popupmenu/exclusive-gateway.png", CamundaCanvasPopupMenuProvider::class.java)
    private val PARALLEL_GATEWAY = IconLoader.getIcon("/icons/popupmenu/parallel-gateway.png", CamundaCanvasPopupMenuProvider::class.java)
    private val INCLUSIVE_GATEWAY = IconLoader.getIcon("/icons/popupmenu/inclusive-gateway.png", CamundaCanvasPopupMenuProvider::class.java)
    private val EVENT_GATEWAY = IconLoader.getIcon("/icons/popupmenu/event-gateway.png", CamundaCanvasPopupMenuProvider::class.java)
    private val COMPLEX_GATEWAY = IconLoader.getIcon("/icons/popupmenu/complex-gateway.png", CamundaCanvasPopupMenuProvider::class.java)
