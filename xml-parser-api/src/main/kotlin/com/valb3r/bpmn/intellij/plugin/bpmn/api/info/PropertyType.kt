...
enum class PropertyType(
    ...
    MULTI_INSTANCE_LOOP_IS_SEQUENTIAL("multiInstanceLoopCharacteristics.isSequential", "Multi instance loop-Is sequential", BOOLEAN),
    MULTI_INSTANCE_LOOP_COLLECTION("multiInstanceLoopCharacteristics.collection", "Multi instance loop-collection", STRING),
    MULTI_INSTANCE_LOOP_ELEMENT_VARIABLE("multiInstanceLoopCharacteristics.elementVariable", "Multi instance loop-elementVariable", STRING),
    MULTI_INSTANCE_LOOP_CARDINALITY_TYPE("multiInstanceLoopCharacteristics.loopCardinality.type", "Multi instance loop-Cardinality type", STRING),
    MULTI_INSTANCE_LOOP_CARDINALITY_EXPRESSION("multiInstanceLoopCharacteristics.loopCardinality.expression", "Multi instance loop-Cardinality expression", STRING),
    MULTI_INSTANCE_COMPLETION_CONDITION_TYPE("multiInstanceLoopCharacteristics.completionCondition.type", "Multi instance loop-Completion condition type", STRING),
    MULTI_INSTANCE_COMPLETION_CONDITION_EXPRESSION("multiInstanceLoopCharacteristics.completionCondition.expression", "Multi instance loop-Completion condition expression", STRING),
