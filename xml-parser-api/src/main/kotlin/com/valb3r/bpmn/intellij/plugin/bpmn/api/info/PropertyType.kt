...
enum class PropertyType(
    ...
    BPMN_INCOMING("incoming", "Incoming reference", STRING, "incoming", false, ID, visible = false, indexInGroupArrayName = "@"),
    BPMN_OUTGOING("outgoing", "Outgoing reference", STRING, "outgoing", false, ID, visible = false, indexInGroupArrayName = "@"),
