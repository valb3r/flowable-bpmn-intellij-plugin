...
enum class PropertyType(
    ...
    TIME_DATE("timerEventDefinition.timeDate.timeDate", "Time date in ISO-8601", T_EXPRESSION),
    TIME_DATE_EXPRESSION_TYPE("timerEventDefinition.timeDate.type", "", STRING, "timerEventDefinition.timeDate.type", visible = false),
    TIME_DURATION("timerEventDefinition.timeDuration.timeDuration", "Time duration (e.g. PT5M)", T_EXPRESSION),
    TIME_DURATION_EXPRESSION_TYPE("timerEventDefinition.timeDuration.type", "", STRING, visible = false),
    TIME_CYCLE("timerEventDefinition.timeCycle.timeCycle", "Time cycle (e.g. R3/PT10H)", T_EXPRESSION),
    TIME_CYCLE_EXPRESSION_TYPE("timerEventDefinition.timeCycle.type", "", STRING, visible = false),
