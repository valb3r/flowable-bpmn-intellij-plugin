...
enum class PropertyType(
    ...
    IS_USE_LOCAL_SCOPE_FOR_RESULT_VARIABLE("useLocalScopeForResultVariable", "Use local scope for result variable", BOOLEAN),
    ...
    MULTI_INSTANCE_LOOP_CARDINALITY_EXPRESSION("multiInstanceLoopCharacteristics.loopCardinality.expression", "Multi instance loop-Cardinality expression", STRING, group = listOf(FunctionalGroupType.MULTI_INSTANCE_LOOP)),
    MULTI_INSTANCE_COMPLETION_CONDITION_TYPE("multiInstanceLoopCharacteristics.completionCondition.type", "Multi instance loop-Completion condition type", STRING, group = listOf(FunctionalGroupType.MULTI_INSTANCE_LOOP)),
    MULTI_INSTANCE_COMPLETION_CONDITION_EXPRESSION("multiInstanceLoopCharacteristics.completionCondition.expression", "Multi instance loop-Completion condition expression", STRING, group = listOf(FunctionalGroupType.MULTI_INSTANCE_LOOP)),
...
enum class FunctionalGroupType(val groupCaption: String, val actionResult: NewElem, val actionUiOnlyResult: List<NewElem> = listOf(), val createExpansionButton: Boolean = true, val actionCaption: String = "",) {
    ...
    MULTI_INSTANCE_LOOP("Multi instance loop characteristics", createExpansionButton = false, actionResult = NewElem("MULTI_INSTANCE_LOOP_IS_SEQUENTIAL", ""),
        actionUiOnlyResult = listOf(
            NewElem("MULTI_INSTANCE_LOOP_COLLECTION", ""),
            NewElem("MULTI_INSTANCE_LOOP_ELEMENT_VARIABLE", ""),
            NewElem("MULTI_INSTANCE_LOOP_CARDINALITY_TYPE", ""),
            NewElem("MULTI_INSTANCE_LOOP_CARDINALITY_EXPRESSION", ""),
            NewElem("MULTI_INSTANCE_COMPLETION_CONDITION_TYPE", ""),
            NewElem("MULTI_INSTANCE_COMPLETION_CONDITION_EXPRESSION", "")
        )
    ),
