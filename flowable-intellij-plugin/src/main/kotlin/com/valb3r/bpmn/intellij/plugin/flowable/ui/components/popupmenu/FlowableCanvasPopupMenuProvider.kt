...
class FlowableCanvasPopupMenuProvider(private val project: Project) : CanvasPopupMenuProvider {

    // Functional
    private val COPY = IconLoader.getIcon("/icons/actions/copy.png", FlowableCanvasPopupMenuProvider::class.java)
    private val CUT = IconLoader.getIcon("/icons/actions/cut.png", FlowableCanvasPopupMenuProvider::class.java)
    private val PASTE = IconLoader.getIcon("/icons/actions/paste.png", FlowableCanvasPopupMenuProvider::class.java)
    private val SAVE_TO_PNG = IconLoader.getIcon("/icons/actions/save-to-png.png", FlowableCanvasPopupMenuProvider::class.java)

    // Events
    // Start
    private val START_EVENT = IconLoader.getIcon("/icons/popupmenu/start-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val START_CONDITIONAL_EVENT = IconLoader.getIcon("/icons/popupmenu/conditional-start-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val START_MESSAGE_EVENT = IconLoader.getIcon("/icons/popupmenu/message-start-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val START_ERROR_EVENT = IconLoader.getIcon("/icons/popupmenu/error-start-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val START_ESCALATION_EVENT = IconLoader.getIcon("/icons/popupmenu/escalation-start-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val START_SIGNAL_EVENT = IconLoader.getIcon("/icons/popupmenu/signal-start-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val START_TIMER_EVENT = IconLoader.getIcon("/icons/popupmenu/timer-start-event.png", FlowableCanvasPopupMenuProvider::class.java)
    // End
    private val END_EVENT = IconLoader.getIcon("/icons/popupmenu/end-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val CANCEL_END_EVENT = IconLoader.getIcon("/icons/popupmenu/cancel-end-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val ERROR_END_EVENT = IconLoader.getIcon("/icons/popupmenu/error-end-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val ESCALATION_END_EVENT = IconLoader.getIcon("/icons/popupmenu/escalation-end-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val TERMINATE_END_EVENT = IconLoader.getIcon("/icons/popupmenu/terminate-end-event.png", FlowableCanvasPopupMenuProvider::class.java)
    // Boundary
    private val BOUNDARY_CANCEL_EVENT = IconLoader.getIcon("/icons/popupmenu/cancel-boundary-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_COMPENSATION_EVENT = IconLoader.getIcon("/icons/popupmenu/compensation-boundary-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_CONDITIONAL_EVENT = IconLoader.getIcon("/icons/popupmenu/conditional-boundary-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_ERROR_EVENT = IconLoader.getIcon("/icons/popupmenu/error-boundary-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_ESCALATION_EVENT = IconLoader.getIcon("/icons/popupmenu/escalation-boundary-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_MESSAGE_EVENT = IconLoader.getIcon("/icons/popupmenu/message-boundary-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_SIGNAL_EVENT = IconLoader.getIcon("/icons/popupmenu/signal-boundary-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val BOUNDARY_TIMER_EVENT = IconLoader.getIcon("/icons/popupmenu/timer-boundary-event.png", FlowableCanvasPopupMenuProvider::class.java)
    // Intermediate events
    // Catch
    private val INTERMEDIATE_TIMER_CATCHING = IconLoader.getIcon("/icons/popupmenu/timer-catch-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val INTERMEDIATE_MESSAGE_CATCHING = IconLoader.getIcon("/icons/popupmenu/message-catch-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val INTERMEDIATE_SIGNAL_CATCHING = IconLoader.getIcon("/icons/popupmenu/signal-catch-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val INTERMEDIATE_CONDITIONAL_CATCHING = IconLoader.getIcon("/icons/popupmenu/conditional-catch-event.png", FlowableCanvasPopupMenuProvider::class.java)
    // Throw
    private val INTERMEDIATE_NONE_THROWING = IconLoader.getIcon("/icons/popupmenu/none-throw-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val INTERMEDIATE_SIGNAL_THROWING = IconLoader.getIcon("/icons/popupmenu/signal-throw-event.png", FlowableCanvasPopupMenuProvider::class.java)
    private val INTERMEDIATE_ESCALATION_THROWING = IconLoader.getIcon("/icons/popupmenu/escalation-throw-event.png", FlowableCanvasPopupMenuProvider::class.java)

    // Service-task alike
    private val SERVICE_TASK = IconLoader.getIcon("/icons/popupmenu/service-task.png", FlowableCanvasPopupMenuProvider::class.java)
    private val USER_TASK = IconLoader.getIcon("/icons/popupmenu/user-task.png", FlowableCanvasPopupMenuProvider::class.java)
    private val SCRIPT_TASK = IconLoader.getIcon("/icons/popupmenu/script-task.png", FlowableCanvasPopupMenuProvider::class.java)
    private val BUSINESS_RULE_TASK = IconLoader.getIcon("/icons/popupmenu/business-rule-task.png", FlowableCanvasPopupMenuProvider::class.java)
    private val RECEIVE_TASK = IconLoader.getIcon("/icons/popupmenu/receive-task.png", FlowableCanvasPopupMenuProvider::class.java)
    private val MANUAL_TASK = IconLoader.getIcon("/icons/popupmenu/manual-task.png", FlowableCanvasPopupMenuProvider::class.java)
    private val CAMEL_TASK = IconLoader.getIcon("/icons/popupmenu/camel-task.png", FlowableCanvasPopupMenuProvider::class.java)
    private val HTTP_TASK = IconLoader.getIcon("/icons/popupmenu/http-task.png", FlowableCanvasPopupMenuProvider::class.java)
    private val MAIL_TASK = IconLoader.getIcon("/icons/popupmenu/mail-task.png", FlowableCanvasPopupMenuProvider::class.java)
    private val MULE_TASK = IconLoader.getIcon("/icons/popupmenu/mule-task.png", FlowableCanvasPopupMenuProvider::class.java)
    private val DECISION_TASK = IconLoader.getIcon("/icons/popupmenu/decision-task.png", FlowableCanvasPopupMenuProvider::class.java)
    private val SHELL_TASK = IconLoader.getIcon("/icons/popupmenu/shell-task.png", FlowableCanvasPopupMenuProvider::class.java)

    // Sub process alike
    private val CALL_ACTIVITY = IconLoader.getIcon("/icons/popupmenu/call-activity.png", FlowableCanvasPopupMenuProvider::class.java)
    private val SUB_PROCESS = IconLoader.getIcon("/icons/popupmenu/subprocess.png", FlowableCanvasPopupMenuProvider::class.java)
    private val EVENT_SUB_PROCESS = IconLoader.getIcon("/icons/popupmenu/event-subprocess.png", FlowableCanvasPopupMenuProvider::class.java)
    private val ADHOC_SUB_PROCESS = IconLoader.getIcon("/icons/popupmenu/adhoc-subprocess.png", FlowableCanvasPopupMenuProvider::class.java)

    // Gateway
    private val EXCLUSIVE_GATEWAY = IconLoader.getIcon("/icons/popupmenu/exclusive-gateway.png", FlowableCanvasPopupMenuProvider::class.java)
    private val PARALLEL_GATEWAY = IconLoader.getIcon("/icons/popupmenu/parallel-gateway.png", FlowableCanvasPopupMenuProvider::class.java)
    private val INCLUSIVE_GATEWAY = IconLoader.getIcon("/icons/popupmenu/inclusive-gateway.png", FlowableCanvasPopupMenuProvider::class.java)
    private val EVENT_GATEWAY = IconLoader.getIcon("/icons/popupmenu/event-gateway.png", FlowableCanvasPopupMenuProvider::class.java)
