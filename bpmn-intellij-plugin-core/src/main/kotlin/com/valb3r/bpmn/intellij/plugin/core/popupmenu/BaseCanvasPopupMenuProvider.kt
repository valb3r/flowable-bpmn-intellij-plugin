...
abstract class BaseCanvasPopupMenuProvider(private val project: Project) : CanvasPopupMenuProvider {
    ...
    protected val START_EVENT = MenuItemDef("Start event",  START_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnStartEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnStartEvent::class, focus)}, 'n')
    protected val START_CONDITIONAL_EVENT = MenuItemDef("Start conditional event",  START_CONDITIONAL_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnStartConditionalEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnStartConditionalEvent::class, focus)}, 'c')
    protected val START_MESSAGE_EVENT = MenuItemDef("Start message event",  START_MESSAGE_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnStartMessageEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnStartMessageEvent::class, focus)}, 'm')
    protected val START_ERROR_EVENT = MenuItemDef("Start error event",  START_ERROR_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnStartErrorEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnStartErrorEvent::class, focus)}, 'r')
    protected val START_ESCALATION_EVENT = MenuItemDef("Start escalation event",  START_ESCALATION_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnStartEscalationEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnStartEscalationEvent::class, focus)}, 'e')
    protected val START_SIGNAL_EVENT = MenuItemDef("Start signal event",  START_SIGNAL_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnStartSignalEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnStartSignalEvent::class, focus)}, 's')
    protected val START_TIMER_EVENT = MenuItemDef("Start timer event",  START_TIMER_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnStartTimerEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnStartTimerEvent::class, focus)}, 't')
    protected val BOUNDARY_CANCEL_EVENT = MenuItemDef("Boundary cancel event",  BOUNDARY_CANCEL_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnBoundaryCancelEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnBoundaryCancelEvent::class, focus)}, 'c')
    protected val BOUNDARY_COMPENSATION_EVENT = MenuItemDef("Boundary compensation event",  BOUNDARY_COMPENSATION_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnBoundaryCompensationEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnBoundaryCompensationEvent::class, focus)}, 'o')
    protected val BOUNDARY_CONDITIONAL_EVENT = MenuItemDef("Boundary conditional event",  BOUNDARY_CONDITIONAL_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnBoundaryConditionalEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnBoundaryConditionalEvent::class, focus)}, 'n')
    protected val BOUNDARY_ERROR_EVENT = MenuItemDef("Boundary error event",  BOUNDARY_ERROR_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnBoundaryErrorEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnBoundaryErrorEvent::class, focus)}, 'r')
    protected val BOUNDARY_ESCALATION_EVENT = MenuItemDef("Boundary escalation event",  BOUNDARY_ESCALATION_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnBoundaryEscalationEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnBoundaryEscalationEvent::class, focus)}, 'e')
    protected val BOUNDARY_MESSAGE_EVENT = MenuItemDef("Boundary message event",  BOUNDARY_MESSAGE_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnBoundaryMessageEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnBoundaryMessageEvent::class, focus)}, 'm')
    protected val BOUNDARY_SIGNAL_EVENT = MenuItemDef("Boundary signal event",  BOUNDARY_SIGNAL_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnBoundarySignalEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnBoundarySignalEvent::class, focus)}, 's')
    protected val BOUNDARY_TIMER_EVENT = MenuItemDef("Boundary timer event",  BOUNDARY_TIMER_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnBoundaryTimerEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnBoundaryTimerEvent::class, focus)}, 't')
    protected val END_EVENT = MenuItemDef("End event",  END_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnEndEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnEndEvent::class, focus)}, 'n')
    protected val END_ERROR_EVENT = MenuItemDef("End error event",  ERROR_END_EVENT_ICON, { project, sceneLocation, focus -> ShapeCreator(project, BpmnEndErrorEvent::class, sceneLocation, focus)}, { project, focus ->  ShapeTypeChange(project, BpmnEndErrorEvent::class, focus)}, 'r')
    protected val END_ESCALATION_EVENT = MenuItemDef("End escalation event",  ESCALATION_END_EVENT_ICON, { project, sceneLocation, focus -> ShapeCreator(project, BpmnEndEscalationEvent::class, sceneLocation, focus)}, { project, focus ->  ShapeTypeChange(project, BpmnEndEscalationEvent::class, focus)},'e')
    protected val END_CANCEL_EVENT = MenuItemDef("End cancel event",  CANCEL_END_EVENT_ICON, { project, sceneLocation, focus -> ShapeCreator(project, BpmnEndCancelEvent::class, sceneLocation, focus)}, { project, focus ->  ShapeTypeChange(project, BpmnEndCancelEvent::class, focus)}, 'c')
    protected val END_TERMINATE_EVENT = MenuItemDef("End terminate event",  TERMINATE_END_EVENT_ICON, { project, sceneLocation, focus -> ShapeCreator(project, BpmnEndTerminateEvent::class, sceneLocation, focus)}, { project, focus ->  ShapeTypeChange(project, BpmnEndTerminateEvent::class, focus)}, 't')
    ...
    protected val INTERMEDIATE_CONDITIONAL_CATCHING_EVENT = MenuItemDef("Intermediate conditional catching event",  INTERMEDIATE_CONDITIONAL_CATCHING_ICON, { project, sceneLocation, focus -> ShapeCreator(project, BpmnIntermediateConditionalCatchingEvent::class, sceneLocation, focus)}, { project, focus ->  ShapeTypeChange(project, BpmnIntermediateConditionalCatchingEvent::class, focus)}, 'n')
    protected val INTERMEDIATE_LINK_CATCHING_EVENT = MenuItemDef("Intermediate link catching event",  INTERMEDIATE_LINK_CATCHING_ICON, { project, sceneLocation, focus -> ShapeCreator(project, BpmnIntermediateLinkCatchingEvent::class, sceneLocation, focus)}, { project, focus ->  ShapeTypeChange(project, BpmnIntermediateLinkCatchingEvent::class, focus)}, 'l')
    protected val SUB_PROCESS = MenuItemDef("Sub process",  SUB_PROCESS_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnSubProcess::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnSubProcess::class, focus)}, 's')
    protected val EVENT_SUB_PROCESS = MenuItemDef("Event sub process",  EVENT_SUB_PROCESS_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnEventSubprocess::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnEventSubprocess::class, focus)}, 'e')
    protected val CALL_ACTIVITY = MenuItemDef("Call activity",  CALL_ACTIVITY_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnCallActivity::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnCallActivity::class, focus)}, 'c')
    protected val ADHOC_SUB_PROCESS = MenuItemDef("Adhoc sub process",  ADHOC_SUB_PROCESS_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnAdHocSubProcess::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnAdHocSubProcess::class, focus)}, 'a')
    protected val EXCLUSIVE_GATEWAY = MenuItemDef("Exclusive gateway",  EXCLUSIVE_GATEWAY_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnExclusiveGateway::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnExclusiveGateway::class, focus)}, 'x')
    ...
    protected val INCLUSIVE_GATEWAY = MenuItemDef("Inclusive gateway",  INCLUSIVE_GATEWAY_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnInclusiveGateway::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnInclusiveGateway::class, focus)}, 'i')
    protected val EVENT_GATEWAY = MenuItemDef("Event gateway",  EVENT_GATEWAY_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnEventGateway::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnEventGateway::class, focus)}, 'e')
    protected val COMPLEX_GATEWAY = MenuItemDef("Complex gateway",  COMPLEX_GATEWAY_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnComplexGateway::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnComplexGateway::class, focus)}, 'c')
    protected val TASK = MenuItemDef("Task",  TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnTask::class, focus)}, 't')
    protected val SEND_TASK = MenuItemDef("Send task",  SEND_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnSendTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnSendTask::class, focus)}, 'n')
    protected val USER_TASK = MenuItemDef("User Task",  USER_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnUserTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnUserTask::class, focus)}, 'u')
    protected val SERVICE_TASK = MenuItemDef("Service Task",  SERVICE_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnServiceTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnServiceTask::class, focus)}, 's')
    protected val SCRIPT_TASK = MenuItemDef("Script Task",  SCRIPT_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnScriptTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnScriptTask::class, focus)}, 'c')
    protected val BUSINESS_RULE_TASK = MenuItemDef("Business rule Task",  BUSINESS_RULE_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnBusinessRuleTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnBusinessRuleTask::class, focus)}, 'r')
    protected val RECEIVE_TASK = MenuItemDef("Receive Task",  RECEIVE_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnReceiveTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnReceiveTask::class, focus)}, 'e')
    protected val MANUAL_TASK = MenuItemDef("Manual Task",  MANUAL_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnManualTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnManualTask::class, focus)}, 'a')
    protected val CAMEL_TASK = MenuItemDef("Camel Task",  CAMEL_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnCamelTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnCamelTask::class, focus)}, 'l')
    protected val HTTP_TASK = MenuItemDef("Http task",  HTTP_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnHttpTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnHttpTask::class, focus)}, 'h')
    protected val MAIL_TASK = MenuItemDef("Mail task",  MAIL_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnMailTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnMailTask::class, focus)}, 'm')
    protected val MULE_TASK = MenuItemDef("Mule task",  MULE_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnMuleTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnMuleTask::class, focus)}, 'u')
    protected val DECISION_TASK = MenuItemDef("Decision task",  DECISION_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnDecisionTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnDecisionTask::class, focus)}, 'd')
    ...
    protected fun JMenu.addNewElementItem(sceneLocation: Point2D.Float, focus: BpmnElementId, menuItem: MenuItemDef) {
        ...
        menuItem.keyStroke?.let { item.accelerator = KeyStroke.getKeyStroke(menuItem.keyStroke) }
        this.add(item)
    }
