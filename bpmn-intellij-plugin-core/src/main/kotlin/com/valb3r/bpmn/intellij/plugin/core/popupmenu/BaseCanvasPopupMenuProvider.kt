...
abstract class BaseCanvasPopupMenuProvider(private val project: Project) : CanvasPopupMenuProvider {
    ...
    protected val BOUNDARY_CONDITIONAL_EVENT = MenuItemDef("Boundary conditional event",  BOUNDARY_CONDITIONAL_EVENT_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnBoundaryConditionalEvent::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnStartConditionalEvent::class, focus)})
    ...
    protected val SEND_EVENT_TASK = MenuItemDef("Send event task", SEND_TASK_ICON, {project, sceneLocation, focus -> ShapeCreator(project, BpmnSendEventTask::class, sceneLocation, focus)}, {project, focus ->  ShapeTypeChange(project, BpmnExternalTask::class, focus)})
