...
data class BpmnElementChangeEvent(override val bpmnElementId: BpmnElementId, override val newBpmnElement: WithBpmnId, override val nameElemWithTypeForXml: Pair<WithBpmnId, String> = Pair(BpmnDummy(), "")): BpmnElementChange
