...
data class IconProviderImpl(
        override val undo: Icon = IconManager.getInstance().getIcon("/icons/actions/undo.png", IconProvider::class.java.classLoader),
        override val redo: Icon = IconManager.getInstance().getIcon("/icons/actions/redo.png", IconProvider::class.java.classLoader),
        override val centerImage: Icon = IconManager.getInstance().getIcon("/icons/actions/center_image.png", IconProvider::class.java.classLoader),
        override val zoomIn: Icon = IconManager.getInstance().getIcon("/icons/actions/zoom_in.png", IconProvider::class.java.classLoader),
        override val zoomOut: Icon = IconManager.getInstance().getIcon("/icons/actions/zoom_out.png", IconProvider::class.java.classLoader),
        override val zoomReset: Icon = IconManager.getInstance().getIcon("/icons/actions/zoom_reset.png", IconProvider::class.java.classLoader),
        override val grid: Icon = IconManager.getInstance().getIcon("/icons/actions/small-grid.png", IconProvider::class.java.classLoader),
        override val gridDense: Icon = IconManager.getInstance().getIcon("/icons/actions/grid.png", IconProvider::class.java.classLoader),
        override val noGrid: Icon = IconManager.getInstance().getIcon("/icons/actions/no-grid.png", IconProvider::class.java.classLoader),
        override val gear: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/gear.png", IconProvider::class.java.classLoader),
        override val triggered: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/triggired.png", IconProvider::class.java.classLoader),
        override val external: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/external.png", IconProvider::class.java.classLoader),
        override val script: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/script.png", IconProvider::class.java.classLoader),
        override val businessRule: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/business-rule.png", IconProvider::class.java.classLoader),
        override val receive: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/receive.png", IconProvider::class.java.classLoader),
        override val manual: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/manual.png", IconProvider::class.java.classLoader),
        override val user: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/user.png", IconProvider::class.java.classLoader),
        override val camel: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/camel.png", IconProvider::class.java.classLoader),
        override val http: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/http.png", IconProvider::class.java.classLoader),
        override val mail: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/mail.png", IconProvider::class.java.classLoader),
        override val mule: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/mule.png", IconProvider::class.java.classLoader),
        override val envelope: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/envelope.png", IconProvider::class.java.classLoader),
        override val decision: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/decision.png", IconProvider::class.java.classLoader),
        override val shell: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/shell.png", IconProvider::class.java.classLoader),
        override val tilde: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/tilde.png", IconProvider::class.java.classLoader),
        override val dragToResizeTop: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/drag-to-resize-top.png", IconProvider::class.java.classLoader),
        override val dragToResizeBottom: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/drag-to-resize-bottom.png", IconProvider::class.java.classLoader),
        override val sequence: Icon = IconManager.getInstance().getIcon("/icons/ui-icons/sequence.png", IconProvider::class.java.classLoader),
        override val anchorOn: Icon = IconManager.getInstance().getIcon("/icons/actions/anchor.png", IconProvider::class.java.classLoader),
