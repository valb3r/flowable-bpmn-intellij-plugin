...
fun readAndUpdateProcess(parser: ActivityParser, event: EventPropagatableToXml): BpmnProcessObject {
    return readAndUpdateProcess(parser, "simple-nested.bmpn20.xml", event)
}

fun readAndUpdateProcess(parser: ActivityParser, processName: String, event: EventPropagatableToXml): BpmnProcessObject {
