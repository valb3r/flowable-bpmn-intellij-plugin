...
internal class CollapsedSubprocessTest {
    ...
    fun `Collapsed subprocess is readable and mapped`() {
        ...
        processObject = ActivityParser().parse("simple-collapsed-subprocess.bpmn20.xml".asResource()!!)
    ...
    fun `Collapsed transactional subprocess is readable and mapped`() {
        ...
        processObject = ActivityParser().parse("transactional-collapsed-subprocess.bpmn20.xml".asResource()!!)
