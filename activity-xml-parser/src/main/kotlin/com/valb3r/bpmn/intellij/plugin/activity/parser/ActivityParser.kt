...
import com.valb3r.bpmn.intellij.plugin.activity.parser.nodes.BpmnFile
import com.valb3r.bpmn.intellij.plugin.activity.parser.nodes.DiagramNode
import com.valb3r.bpmn.intellij.plugin.activity.parser.nodes.ProcessNode
...
enum class PropertyTypeDetails(
    ...
    ASYNC(PropertyType.ASYNC, "activity:async", XmlType.ATTRIBUTE),
    ASSIGNEE(PropertyType.ASSIGNEE, "activity:assignee", XmlType.ATTRIBUTE),
    CALLED_ELEM(PropertyType.CALLED_ELEM, "calledElement", XmlType.ATTRIBUTE),
    CALLED_ELEM_TYPE(PropertyType.CALLED_ELEM_TYPE, "activity:calledElementType", XmlType.ATTRIBUTE),
    INHERIT_VARS(PropertyType.INHERIT_VARS, "activity:inheritVariables", XmlType.ATTRIBUTE),
    FALLBACK_TO_DEF_TENANT(PropertyType.FALLBACK_TO_DEF_TENANT, "activity:fallbackToDefaultTenant", XmlType.ATTRIBUTE),
    EXCLUSIVE(PropertyType.EXCLUSIVE,"activity:exclusive", XmlType.ATTRIBUTE),
    EXPRESSION(PropertyType.EXPRESSION, "activity:expression", XmlType.ATTRIBUTE),
    DELEGATE_EXPRESSION(PropertyType.DELEGATE_EXPRESSION, "activity:delegateExpression", XmlType.ATTRIBUTE),
    CLASS(PropertyType.CLASS, "activity:class", XmlType.ATTRIBUTE),
    SKIP_EXPRESSION(PropertyType.SKIP_EXPRESSION, "activity:skipExpression", XmlType.ATTRIBUTE),
    IS_TRIGGERABLE(PropertyType.IS_TRIGGERABLE, "activity:triggerable", XmlType.ATTRIBUTE),
    DUE_DATE(PropertyType.DUE_DATE, "activity:dueDate", XmlType.ATTRIBUTE),
    CATEGORY(PropertyType.CATEGORY, "activity:category", XmlType.ATTRIBUTE),
    FORM_KEY(PropertyType.FORM_KEY, "activity:formKey", XmlType.ATTRIBUTE),
    FORM_FIELD_VALIDATION(PropertyType.FORM_FIELD_VALIDATION, "activity:formFieldValidation", XmlType.ATTRIBUTE),
    PRIORITY(PropertyType.PRIORITY, "activity:priority", XmlType.ATTRIBUTE),
    ...
    AUTO_STORE_VARIABLES(PropertyType.AUTO_STORE_VARIABLES, "activity:autoStoreVariables", XmlType.ATTRIBUTE),
    RULE_VARIABLES_INPUT(PropertyType.RULE_VARIABLES_INPUT, "activity:ruleVariablesInput", XmlType.ATTRIBUTE),
    RULES(PropertyType.RULES, "activity:rules", XmlType.ATTRIBUTE),
    RESULT_VARIABLE(PropertyType.RESULT_VARIABLE, "activity:resultVariable", XmlType.ATTRIBUTE),
    RESULT_VARIABLE_NAME(PropertyType.RESULT_VARIABLE_NAME, "activity:resultVariableName", XmlType.ATTRIBUTE),
    EXCLUDE(PropertyType.EXCLUDE, "activity:exclude", XmlType.ATTRIBUTE),
    ...
    IS_USE_LOCAL_SCOPE_FOR_RESULT_VARIABLE(PropertyType.IS_USE_LOCAL_SCOPE_FOR_RESULT_VARIABLE, "activity:useLocalScopeForResultVariable", XmlType.ATTRIBUTE),
    CAMEL_CONTEXT(PropertyType.CAMEL_CONTEXT, "extensionElements.activity:field?name=camelContext.activity:string.text", XmlType.CDATA),
    DECISION_TABLE_REFERENCE_KEY(PropertyType.DECISION_TABLE_REFERENCE_KEY, "extensionElements.activity:field?name=decisionTableReferenceKey.activity:string.text", XmlType.CDATA),
    DECISION_TASK_THROW_ERROR_ON_NO_HITS(PropertyType.DECISION_TASK_THROW_ERROR_ON_NO_HITS, "extensionElements.activity:field?name=decisionTaskThrowErrorOnNoHits.activity:string.text", XmlType.CDATA),
    FALLBACK_TO_DEF_TENANT_CDATA(PropertyType.FALLBACK_TO_DEF_TENANT_CDATA, "extensionElements.activity:field?name=fallbackToDefaultTenant.activity:string.text", XmlType.CDATA),
    REQUEST_METHOD(PropertyType.REQUEST_METHOD, "extensionElements.activity:field?name=requestMethod.activity:string.text", XmlType.CDATA),
    REQUEST_URL(PropertyType.REQUEST_URL, "extensionElements.activity:field?name=requestUrl.activity:string.text", XmlType.CDATA),
    REQUEST_HEADERS(PropertyType.REQUEST_HEADERS, "extensionElements.activity:field?name=requestHeaders.activity:string.text", XmlType.CDATA),
    REQUEST_BODY(PropertyType.REQUEST_BODY, "extensionElements.activity:field?name=requestBody.activity:string.text", XmlType.CDATA),
    REQUEST_BODY_ENCODING(PropertyType.REQUEST_BODY_ENCODING, "extensionElements.activity:field?name=requestBodyEncoding.activity:string.text", XmlType.CDATA),
    REQUEST_TIMEOUT(PropertyType.REQUEST_TIMEOUT, "extensionElements.activity:field?name=requestTimeout.activity:string.text", XmlType.CDATA),
    DISALLOW_REDIRECTS(PropertyType.DISALLOW_REDIRECTS, "extensionElements.activity:field?name=disallowRedirects.activity:string.text", XmlType.CDATA),
    FAIL_STATUS_CODES(PropertyType.FAIL_STATUS_CODES, "extensionElements.activity:field?name=failStatusCodes.activity:string.text", XmlType.CDATA),
    HANDLE_STATUS_CODES(PropertyType.HANDLE_STATUS_CODES, "extensionElements.activity:field?name=handleStatusCodes.activity:string.text", XmlType.CDATA),
    RESPONSE_VARIABLE_NAME(PropertyType.RESPONSE_VARIABLE_NAME, "extensionElements.activity:field?name=responseVariableName.activity:string.text", XmlType.CDATA),
    IGNORE_EXCEPTION(PropertyType.IGNORE_EXCEPTION, "extensionElements.activity:field?name=ignoreException.activity:string.text", XmlType.CDATA),
    SAVE_REQUEST_VARIABLES(PropertyType.SAVE_REQUEST_VARIABLES, "extensionElements.activity:field?name=saveRequestVariables.activity:string.text", XmlType.CDATA),
    SAVE_RESPONSE_PARAMETERS(PropertyType.SAVE_RESPONSE_PARAMETERS, "extensionElements.activity:field?name=saveResponseParameters.activity:string.text", XmlType.CDATA),
    RESULT_VARIABLE_PREFIX(PropertyType.RESULT_VARIABLE_PREFIX, "extensionElements.activity:field?name=resultVariablePrefix.activity:string.text", XmlType.CDATA),
    SAVE_RESPONSE_PARAMETERS_TRANSIENT(PropertyType.SAVE_RESPONSE_PARAMETERS_TRANSIENT, "extensionElements.activity:field?name=saveResponseParametersTransient.activity:string.text", XmlType.CDATA),
    SAVE_RESPONSE_VARIABLE_AS_JSON(PropertyType.SAVE_RESPONSE_VARIABLE_AS_JSON, "extensionElements.activity:field?name=saveResponseVariableAsJson.activity:string.text", XmlType.CDATA),
    HEADERS(PropertyType.HEADERS, "extensionElements.activity:field?name=headers.activity:string.text", XmlType.CDATA),
    TO(PropertyType.TO, "extensionElements.activity:field?name=to.activity:string.text", XmlType.CDATA),
    FROM(PropertyType.FROM, "extensionElements.activity:field?name=from.activity:string.text", XmlType.CDATA),
    SUBJECT(PropertyType.SUBJECT, "extensionElements.activity:field?name=subject.activity:string.text", XmlType.CDATA),
    CC(PropertyType.CC, "extensionElements.activity:field?name=cc.activity:string.text", XmlType.CDATA),
    BCC(PropertyType.BCC, "extensionElements.activity:field?name=bcc.activity:string.text", XmlType.CDATA),
    TEXT(PropertyType.TEXT, "extensionElements.activity:field?name=text.activity:string.text", XmlType.CDATA),
    HTML(PropertyType.HTML, "extensionElements.activity:field?name=html.activity:string.text", XmlType.CDATA),
    CHARSET(PropertyType.CHARSET, "extensionElements.activity:field?name=charset.activity:string.text", XmlType.CDATA),
    ENDPOINT_URL(PropertyType.ENDPOINT_URL, "extensionElements.activity:field?name=endpointUrl.activity:string.text", XmlType.CDATA),
    LANGUAGE(PropertyType.LANGUAGE, "extensionElements.activity:field?name=language.activity:string.text", XmlType.CDATA),
    PAYLOAD_EXPRESSION(PropertyType.PAYLOAD_EXPRESSION, "extensionElements.activity:field?name=payloadExpression.activity:expression.text", XmlType.CDATA),
    RESULT_VARIABLE_CDATA(PropertyType.RESULT_VARIABLE_CDATA, "extensionElements.activity:field?name=resultVariable.activity:string.text", XmlType.CDATA),
    COMMAND(PropertyType.COMMAND, "extensionElements.activity:field?name=command.activity:string.text", XmlType.CDATA),
    ARG_1(PropertyType.ARG_1, "extensionElements.activity:field?name=arg1.activity:string.text", XmlType.CDATA),
    ARG_2(PropertyType.ARG_2, "extensionElements.activity:field?name=arg2.activity:string.text", XmlType.CDATA),
    ARG_3(PropertyType.ARG_3, "extensionElements.activity:field?name=arg3.activity:string.text", XmlType.CDATA),
    ARG_4(PropertyType.ARG_4, "extensionElements.activity:field?name=arg4.activity:string.text", XmlType.CDATA),
    ARG_5(PropertyType.ARG_5, "extensionElements.activity:field?name=arg5.activity:string.text", XmlType.CDATA),
    WAIT(PropertyType.WAIT, "extensionElements.activity:field?name=wait.activity:string.text", XmlType.CDATA),
    CLEAN_ENV(PropertyType.CLEAN_ENV, "extensionElements.activity:field?name=cleanEnv.activity:string.text", XmlType.CDATA),
    ERROR_CODE_VARIABLE(PropertyType.ERROR_CODE_VARIABLE, "extensionElements.activity:field?name=errorCodeVariable.activity:string.text", XmlType.CDATA),
    OUTPUT_VARIABLE(PropertyType.OUTPUT_VARIABLE, "extensionElements.activity:field?name=outputVariable.activity:string.text", XmlType.CDATA),
    DIRECTORY(PropertyType.DIRECTORY, "extensionElements.activity:field?name=directory.activity:string.text", XmlType.CDATA)
...
class ActivityParser : BpmnParser {
    ...
    enum class NS(val namePrefix: String, val url: String) {
        ...
        FLOWABLE("activity", "http://activiti.org/bpmn"),
